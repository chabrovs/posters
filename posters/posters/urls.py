...
urlpatterns = [
    ...
    path("", RedirectView.as_view(url="posters")),
...
urlpatterns += i18n_patterns(
    path(
        "posters/",
        include(("posters_app.urls", "posters_app"), namespace="posters_app"),
    ),
    path(
        "user_account/",
        include(
            ("user_account_app.urls", "user_account_app"), namespace="user_account_app"
        ),
    ),
)
